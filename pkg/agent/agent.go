...
type Config struct {
	...
	KeepAliveInterval int `env:"KEEPALIVE_INTERVAL" envDefault:"30"`
	...
	PreferredIdentity string `env:"PREFERRED_IDENTITY" envDefault:""`
	...
	Mode Mode `env:"MODE" envDefault:"host"`
}
