...
func (_c *MockClient_AuthDevice_Call) Return(deviceAuthResponse *models.DeviceAuthResponse, err error) *MockClient_AuthDevice_Call {
...
func (_e *MockClient_Expecter) AuthPublicKey(req any, token any) *MockClient_AuthPublicKey_Call {
	return &MockClient_AuthPublicKey_Call{Call: _e.mock.On("AuthPublicKey", req, token)}
}

func (_c *MockClient_AuthPublicKey_Call) Run(run func(req *models.PublicKeyAuthRequest, token string)) *MockClient_AuthPublicKey_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockClient_AuthPublicKey_Call) Return(publicKeyAuthResponse *models.PublicKeyAuthResponse, err error) *MockClient_AuthPublicKey_Call {
	_c.Call.Return(publicKeyAuthResponse, err)
	return _c
}

func (_c *MockClient_AuthPublicKey_Call) RunAndReturn(run func(req *models.PublicKeyAuthRequest, token string) (*models.PublicKeyAuthResponse, error)) *MockClient_AuthPublicKey_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_e *MockClient_Expecter) Endpoints() *MockClient_Endpoints_Call {
	return &MockClient_Endpoints_Call{Call: _e.mock.On("Endpoints")}
}

func (_c *MockClient_Endpoints_Call) Run(run func()) *MockClient_Endpoints_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockClient_Endpoints_Call) Return(endpoints *models.Endpoints, err error) *MockClient_Endpoints_Call {
...
//   - uid string
func (_e *MockClient_Expecter) GetDevice(uid any) *MockClient_GetDevice_Call {
	return &MockClient_GetDevice_Call{Call: _e.mock.On("GetDevice", uid)}
}

func (_c *MockClient_GetDevice_Call) Run(run func(uid string)) *MockClient_GetDevice_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 string
		if args[0] != nil {
			arg0 = args[0].(string)
...
func (_e *MockClient_Expecter) GetInfo(agentVersion any) *MockClient_GetInfo_Call {
	return &MockClient_GetInfo_Call{Call: _e.mock.On("GetInfo", agentVersion)}
}
...
func (_c *MockClient_GetInfo_Call) Return(info *models.Info, err error) *MockClient_GetInfo_Call {
...
func (_e *MockClient_Expecter) ListDevices() *MockClient_ListDevices_Call {
	return &MockClient_ListDevices_Call{Call: _e.mock.On("ListDevices")}
}

func (_c *MockClient_ListDevices_Call) Run(run func()) *MockClient_ListDevices_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_e *MockClient_Expecter) NewReverseListenerV1(ctx any, token any, path any) *MockClient_NewReverseListenerV1_Call {
	return &MockClient_NewReverseListenerV1_Call{Call: _e.mock.On("NewReverseListenerV1", ctx, token, path)}
}

func (_c *MockClient_NewReverseListenerV1_Call) Run(run func(ctx context.Context, token string, path string)) *MockClient_NewReverseListenerV1_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockClient_NewReverseListenerV1_Call) Return(listener net.Listener, err error) *MockClient_NewReverseListenerV1_Call {
	_c.Call.Return(listener, err)
	return _c
}

func (_c *MockClient_NewReverseListenerV1_Call) RunAndReturn(run func(ctx context.Context, token string, path string) (net.Listener, error)) *MockClient_NewReverseListenerV1_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_e *MockClient_Expecter) NewReverseListenerV2(ctx any, token any, path any, cfg any) *MockClient_NewReverseListenerV2_Call {
	return &MockClient_NewReverseListenerV2_Call{Call: _e.mock.On("NewReverseListenerV2", ctx, token, path, cfg)}
}

func (_c *MockClient_NewReverseListenerV2_Call) Run(run func(ctx context.Context, token string, path string, cfg *client.ReverseListenerV2Config)) *MockClient_NewReverseListenerV2_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockClient_NewReverseListenerV2_Call) Return(listener net.Listener, err error) *MockClient_NewReverseListenerV2_Call {
	_c.Call.Return(listener, err)
	return _c
}

func (_c *MockClient_NewReverseListenerV2_Call) RunAndReturn(run func(ctx context.Context, token string, path string, cfg *client.ReverseListenerV2Config) (net.Listener, error)) *MockClient_NewReverseListenerV2_Call {
	_c.Call.Return(run)
	return _c
}
