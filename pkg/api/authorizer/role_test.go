	...
	cases := []struct {
		...
		},
		{
			...
			expected: []authorizer.Permission{
				...
				authorizer.DeviceCustomFieldUpdate,
				authorizer.TagCreate,
				authorizer.TagUpdate,
				authorizer.TagDelete,
				authorizer.SessionPlay,
				authorizer.SessionClose,
				authorizer.SessionRemove,
				authorizer.SessionDetails,
				authorizer.SessionApprove,
				...
				authorizer.ProvisioningKeyCreate,
				authorizer.ProvisioningKeyUpdate,
				authorizer.ProvisioningKeyReveal,
				authorizer.ProvisioningKeyList,
				...
				authorizer.AccessPolicyManage,
				authorizer.SSHIdentityAdd,
				authorizer.SSHIdentityManage,
			},
		},
		{
			description: "succeeds with 'administrator'",
