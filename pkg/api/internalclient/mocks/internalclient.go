...
// RecordSession provides a mock function with given fields: ctx, uid, recordURL
func (_m *Client) RecordSession(ctx context.Context, uid string, recordURL string) (*websocket.Conn, error) {
	ret := _m.Called(ctx, uid, recordURL)

	var r0 *websocket.Conn
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) (*websocket.Conn, error)); ok {
		return rf(ctx, uid, recordURL)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string) *websocket.Conn); ok {
		r0 = rf(ctx, uid, recordURL)
	} else {
		if ret.Get(0) != nil {
