...
// RecordSession provides a mock function with given fields: ctx, uid, camera, recordURL
func (_m *Client) RecordSession(ctx context.Context, uid string, camera chan *models.SessionRecorded, recordURL string) error {
	ret := _m.Called(ctx, uid, camera, recordURL)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, chan *models.SessionRecorded, string) error); ok {
		r0 = rf(ctx, uid, camera, recordURL)
	} else {
		r0 = ret.Error(0)
	}
