...
// InviteMember provides a mock function with given fields: ctx, tenantID, email
func (_m *Client) InviteMember(ctx context.Context, tenantID string, email string) error {
