...
// NotifyConnectedDevicesDecrease provides a mock function with given fields: tenant, target
func (_m *Client) NotifyConnectedDevicesDecrease(tenant string, target string) error {
	ret := _m.Called(tenant, target)

	if len(ret) == 0 {
		panic("no return value specified for NotifyConnectedDevicesDecrease")
	}
...
// NotifyConnectedDevicesIncrease provides a mock function with given fields: tenant, target
func (_m *Client) NotifyConnectedDevicesIncrease(tenant string, target string) error {
	ret := _m.Called(tenant, target)

	if len(ret) == 0 {
		panic("no return value specified for NotifyConnectedDevicesIncrease")
	}
...
// UpdateDeviceConnectionStats provides a mock function with given fields: tenant, uid, connectedAt, disconnectedAt
func (_m *Client) UpdateDeviceConnectionStats(tenant string, uid string, connectedAt time.Time, disconnectedAt time.Time) (int, error) {
	ret := _m.Called(tenant, uid, connectedAt, disconnectedAt)

	if len(ret) == 0 {
		panic("no return value specified for UpdateDeviceConnectionStats")
	}

	var r0 int
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, time.Time, time.Time) (int, error)); ok {
		return rf(tenant, uid, connectedAt, disconnectedAt)
	}
	if rf, ok := ret.Get(0).(func(string, string, time.Time, time.Time) int); ok {
		r0 = rf(tenant, uid, connectedAt, disconnectedAt)
	} else {
		r0 = ret.Get(0).(int)
	}

	if rf, ok := ret.Get(1).(func(string, string, time.Time, time.Time) error); ok {
		r1 = rf(tenant, uid, connectedAt, disconnectedAt)
	} else {
		r1 = ret.Error(1)
	}
