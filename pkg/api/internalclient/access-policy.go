...
type accessPolicyAPI interface {
	...
	AuthorizeSSHAccess(ctx context.Context, tenant, userID, deviceUID, login, sourceIP string) (*models.Decision, error)
...
func (c *client) AuthorizeSSHAccess(ctx context.Context, tenant, userID, deviceUID, login, sourceIP string) (*models.Decision, error) {
