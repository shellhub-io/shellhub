...
export default function MfaRecoveryTimeoutModal({
  ...
  // Keep a stable ref to onClose so the effect below doesn't need to re-register
  // the event listener every time the parent re-renders with a new function reference.
