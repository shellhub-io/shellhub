...
describe("MfaDisableDialog", () => {
  ...
  describe("Error Handling", () => {
    it("clears previous errors when switching modes", async () => {
      ...
      // Switch to recovery mode — error should be cleared
      // Use the mode-switch button specifically (not the Recovery Code label)
      const switchButton = screen.getByRole("button", { name: /use recovery code instead/i });
      await user.click(switchButton);
