...
function CloudForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full">
      <label className="block text-2xs font-mono font-semibold uppercase tracking-[0.15em] text-text-muted mb-2.5">
        Namespace Name
      </label>
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          className="px-6 py-3 bg-primary hover:bg-primary-600 text-white rounded-lg text-sm font-semibold disabled:opacity-40 disabled:cursor-not-allowed transition-all duration-200 shrink-0"
        >
          {loading ? (
...
function CommunityInstructions() {
  ...
  return (
    <div className="w-full space-y-5">
      ...
      {/* Option 1: Create new */}
      <div>
        <p className="text-2xs font-mono font-semibold uppercase tracking-[0.15em] text-text-muted mb-2">
...
export default function CreateNamespace() {
  const canCreate = env.isCloud || env.isEnterprise;
    ...
    <div className="relative w-full min-h-0 flex-1 flex overflow-auto">
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-8 py-12 flex flex-col">
        ...
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p className="text-2xs font-mono font-semibold uppercase tracking-[0.25em] text-primary/80 mb-2">
            Welcome to ShellHub
          </p>
