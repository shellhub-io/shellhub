      ...
      footer={
        <>
          ...
          <button
            ...
            disabled={!canConnect}
            className="px-5 py-2.5 bg-accent-green/90 hover:bg-accent-green text-white rounded-lg text-sm font-semibold disabled:opacity-40 disabled:cursor-not-allowed transition-all flex items-center gap-2"
          >
            ...
            <button
              ...
              className={`flex items-start gap-3 w-full px-3.5 py-3 rounded-lg border text-left transition-all ${
                authMethod === "password"
                  ...
                  : "bg-card border-border hover:border-border-light hover:bg-white/[0.02]"
              }`}
            >
              <div
