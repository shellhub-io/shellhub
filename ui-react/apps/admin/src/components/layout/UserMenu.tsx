  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        className="flex items-center gap-2 h-8 pl-1 pr-2.5 rounded-lg border border-transparent hover:border-border hover:bg-white/[0.03] transition-all duration-150"
      >
        <span className="w-6 h-6 rounded-md bg-primary/15 border border-primary/20 flex items-center justify-center text-primary text-[10px] font-bold font-mono">
          {initials(user)}
        </span>
        ...
        <div className="absolute top-full right-0 mt-1.5 w-56 bg-surface border border-border rounded-lg shadow-2xl shadow-black/40 z-50 overflow-hidden animate-slide-down">
          ...
          <div className="p-1.5">
            <button
              ...
              className="w-full flex items-center gap-2.5 px-3 py-2 rounded-md text-left hover:bg-white/[0.04] transition-colors group"
            >
