  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        className="flex items-center gap-2.5 h-9 px-3 rounded-md border border-transparent hover:border-border hover:bg-white/[0.02] transition-all duration-150"
      >
        {currentNamespace ? (
          <>
        ...
        <div className="absolute top-full left-0 mt-1.5 w-80 bg-surface border border-border rounded-lg shadow-2xl shadow-black/40 z-50 overflow-hidden animate-slide-down">
          {currentNamespace && (
            <div className="p-4 border-b border-border">
              <p className="text-2xs font-mono font-semibold uppercase tracking-[0.15em] text-text-muted mb-3">
                Active Namespace
              </p>
          ...
          {others.length > 0 && (
            <div className="p-2">
              <p className="px-2 py-1.5 text-2xs font-mono font-semibold uppercase tracking-[0.15em] text-text-muted">
                Switch Namespace
              </p>
              {others.map((ns) => (
                <button
                  ...
                  className="w-full flex items-center gap-3 px-2 py-2 rounded-md text-left hover:bg-white/[0.04] transition-colors group"
                >
