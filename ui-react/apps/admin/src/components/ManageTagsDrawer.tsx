        ...
        >
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-3 py-2 bg-primary hover:bg-primary-600 text-white rounded-lg text-sm font-semibold disabled:opacity-40 disabled:cursor-not-allowed transition-all shrink-0"
            >
              {submitting ? (
          ...
          {loading && tags.length === 0 ? (
            ...
            <div className="divide-y divide-border/60">
              {tags.map((tag) => (
                <div
                  key={tag.name}
                  className="group flex items-center gap-2 px-6 py-2.5 hover:bg-white/[0.02] transition-colors"
                >
                  {editingTag === tag.name ? (
                    <input
                      type="text"
