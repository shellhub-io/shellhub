  ...
  return (
    ...
    >
      ...
      <div className="border-b border-border p-4">
        <div className="mb-2.5 text-2xs font-mono font-semibold uppercase tracking-[0.15em] text-text-muted">
          Theme
        </div>
      ...
      <div className="border-b border-border p-4">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            disabled={fontSize <= 8}
            className="rounded-md border border-border bg-white/[0.02] p-1.5 text-text-muted hover:text-text-primary hover:bg-white/[0.05] disabled:opacity-20 transition-colors"
          >
      ...
      <div className="p-4">
        ...
        >
          ...
          <div style={{ color: theme.colors.foreground }}>
            ...
            <span style={{ color: theme.colors.yellow }}>v0.16.0</span>{" "}
    ...
    <button
      ...
      className={`relative rounded-lg border p-2 text-left transition-all duration-150 ${
        selected
          ...
          : "border-border hover:border-border-light bg-white/[0.02]"
      }`}
    >
      {/* Color preview */}
      <div
      ...
      >
        <div
          className="font-mono text-[10px] mb-0.5 truncate"
