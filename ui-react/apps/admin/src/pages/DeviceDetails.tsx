...
/* ─── Shared styles ─── */
const LABEL =
  "text-2xs font-mono font-semibold uppercase tracking-[0.15em] text-text-muted";
        ...
        {(!tags || tags.length < 3) && (
          <div className="flex items-center gap-1.5">
            ...
            <button
              ...
              className="p-1 rounded-md text-text-muted hover:text-primary hover:bg-primary/10 disabled:opacity-30 transition-all"
            >
    ...
    <div>
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="p-1.5 rounded-md text-text-muted hover:bg-white/[0.05] transition-all"
        >
        ...
        <div className="flex items-center gap-2 shrink-0">
          {device.status === "accepted" && (
            <button
              ...
              className="flex items-center gap-2 px-4 py-2.5 bg-accent-green/90 hover:bg-accent-green text-white rounded-lg text-sm font-semibold disabled:opacity-40 disabled:cursor-not-allowed transition-all"
            >
          ...
          <div className="relative bg-surface border border-border rounded-2xl w-full max-w-sm mx-4 p-6 shadow-2xl animate-slide-up">
            ...
            <div className="flex justify-end gap-2">
              ...
              <button
                ...
                disabled={deleting}
                className="px-5 py-2.5 bg-accent-red/90 hover:bg-accent-red text-white rounded-lg text-sm font-semibold disabled:opacity-40 transition-all"
              >
