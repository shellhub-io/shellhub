...
export default function RuleCard({
  ...
  return (
    <div className="group bg-card border border-border rounded-xl p-4 hover:border-border-light hover:bg-white/[0.01] transition-all">
        ...
        <div className="flex items-start gap-3.5 min-w-0 flex-1">
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-2">
              ...
              <span className="inline-flex items-center px-1.5 py-0.5 bg-white/[0.06] text-text-muted text-2xs rounded font-mono">
            ...
            <div className="flex flex-wrap items-center gap-2 mt-2.5">
              {/* Source IP */}
              <span className="inline-flex items-center gap-1 px-1.5 py-0.5 bg-white/[0.04] text-text-muted text-2xs rounded">
