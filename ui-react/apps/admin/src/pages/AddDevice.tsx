    ...
    <button
      ...
      className={`shrink-0 px-3 py-1.5 rounded-md text-2xs font-semibold transition-all ${
        copied
          ...
          : "bg-white/[0.04] text-text-muted hover:text-text-primary hover:bg-white/[0.08] border border-transparent"
      }`}
    >
      {copied ? (
    ...
    <div className="max-w-2xl animate-fade-in">
      ...
      <div className="mb-6">
        <div className="flex items-center gap-2.5 mb-3">
          <span className="w-5 h-5 rounded-full bg-primary/15 border border-primary/25 flex items-center justify-center text-[10px] font-bold text-primary">
            1
          </span>
            ...
            <button
              ...
              className={`flex items-start gap-3 w-full px-3.5 py-3 rounded-lg border text-left transition-all ${
                method === m.id
                  ...
                  : "bg-card border-border hover:bg-white/[0.02]"
              }`}
            >
              <div
