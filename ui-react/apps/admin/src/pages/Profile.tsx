  ...
  return (
    <div className="flex items-center justify-between gap-6 px-5 py-4">
      <div className="flex items-start gap-3 min-w-0 flex-1">
        <span className="w-8 h-8 rounded-lg bg-white/[0.04] border border-border flex items-center justify-center text-text-muted shrink-0 mt-0.5">
          {icon}
        </span>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          <div className="flex items-center gap-2 mb-1.5">
            ...
            <span className="px-1.5 py-0.5 text-[9px] font-mono font-semibold uppercase tracking-wider rounded bg-accent-yellow/10 text-accent-yellow border border-accent-yellow/20">
              Deprecated
            </span>
          </div>
          <input
  ...
  return (
    <div>
      ...
      >
        <button
          onClick={openEdit}
          className="px-4 py-2.5 bg-white/[0.06] hover:bg-white/[0.1] text-text-primary border border-border hover:border-border-light rounded-lg text-sm font-medium transition-all flex items-center gap-2"
        >
        ...
        <SettingsCard title="Security">
          ...
          >
            <button
              ...
              className="px-4 py-2 bg-white/[0.06] hover:bg-white/[0.1] text-text-primary border border-border hover:border-border-light rounded-lg text-sm font-medium transition-all"
            >
              Change Password
            </button>
          </SettingsRow>
