...
import { RoleSelector, EXPIRY_OPTIONS } from "./constants";
    ...
    <Drawer
      ...
      footer={
        generatedKey ? (
          <button
            onClick={onClose}
            className="px-5 py-2.5 bg-primary hover:bg-primary/90 text-white rounded-lg text-sm font-semibold transition-all"
          >
            Done
          </button>
        ) : (
