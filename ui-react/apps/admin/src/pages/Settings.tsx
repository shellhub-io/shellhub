    ...
    return (
      ...
      >
        {canEdit && (
          <Link
            to="/settings/banner"
            className="inline-flex p-1.5 rounded-md text-text-muted hover:text-text-primary hover:bg-white/[0.05] transition-colors"
            title="Edit"
          >
            ...
            <div className="flex items-center gap-2">
              ...
              {canEdit && (
                <button
                  ...
                  className="p-1.5 rounded-md text-text-muted hover:text-text-primary hover:bg-white/[0.05] transition-colors"
                  title="Rename"
                >
                  <PencilSquareIcon className="w-4 h-4" />
                </button>
            ...
            >
              <button
                ...
                className={`h-full px-2.5 text-2xs font-medium rounded transition-all duration-150 ${
                  !sessionRecord
                    ? "bg-white/[0.08] text-text-secondary border border-border-light"
