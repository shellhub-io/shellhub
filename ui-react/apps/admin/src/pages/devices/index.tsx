...
/* ─── Table header config ─── */
const TH =
  "px-4 py-3 text-left text-2xs font-mono font-semibold uppercase tracking-[0.12em] text-text-muted whitespace-nowrap";
                ...
                filtered.map((device) => {
                  ...
                  return (
                    <tr
                      ...
                      className={`group hover:bg-white/[0.02] transition-colors ${device.status === "accepted" ? "cursor-pointer" : ""}`}
                    >
