    ...
    <>
      ...
      {open &&
        createPortal(
          <div
            ref={popoverRef}
            className="fixed z-[9999] w-[300px] bg-surface border border-border rounded-xl shadow-2xl animate-fade-in"
                  ...
                  {tags.map((tag) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        disabled={loading}
                        className="hover:text-white transition-colors disabled:opacity-50 ml-0.5"
                      >
                      ...
                      <div className="mt-1.5 max-h-[140px] overflow-y-auto border border-border rounded-lg divide-y divide-border/60">
                        {suggestions.map((tag) => (
                          <button
                            ...
                            disabled={loading}
                            className="w-full text-left px-2.5 py-1.5 text-2xs text-text-primary hover:bg-white/[0.05] transition-colors disabled:opacity-50 flex items-center gap-1.5"
                          >
                            <TagIcon
                        ...
                        {isNew && (
                          <button
                            ...
                            disabled={loading}
                            className="w-full text-left px-2.5 py-1.5 text-2xs text-accent-green hover:bg-white/[0.05] transition-colors disabled:opacity-50 flex items-center gap-1.5"
                          >
                            <PlusIcon
