        ...
        <tr v-for="(session, index) in sessions" :key="index">
          <td>
            ...
            <v-tooltip anchor="bottom" v-else>
              ...
              <span>{{ session.last_seen ? lastSeen(session.last_seen) : 'N/A' }}</span>
          ...
          <td>
            <span>{{ session.started_at ? formatDate(session.started_at) : 'N/A' }}</span>
          </td>
          <td>
            {{ session.last_seen ? formatDate(session.last_seen) : 'N/A' }}
          </td>
          <td>
