  ...
  <v-card class="mt-2 pa-4 bg-background border">
    <v-card-text v-if="!isDeviceEmpty">
      ...
      <div v-if="device.identity">
        ...
        <p :data-test="device.identity.mac">
          {{ device.identity.mac }}
        </p>
      </div>
      ...
      <div>
        ...
        <ul
          v-for="(value, name, index) in device.info"
          :key="index"
          :data-test="device.info.id"
        >
          <li class="ml-8">
