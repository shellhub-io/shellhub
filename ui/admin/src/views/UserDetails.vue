  ...
  <v-card class="mt-2 pa-4 bg-background border">
    <v-card-text v-if="currentUser">
      ...
      <div>
        ...
        <p :data-test="currentUser.username">
      ...
      <div>
        ...
        <p :data-test="currentUser.namespacesOwned">
          {{ currentUser.namespacesOwned }}
        </p>
      </div>
    </v-card-text>
    <p
