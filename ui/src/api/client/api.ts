 ...
 *
 * The version of the OpenAPI document: 1.0.0-alpha.3
 ...
 * 
 * @export
 * @interface EnableMFA200Response
 */
export interface EnableMFA200Response {
    /**
     * JWT Token
     * @type {string}
     * @memberof EnableMFA200Response
     */
    'token'?: string;
}
/**
 ...
 * 
 * @export
 * @interface GenerateMFA200Response
 */
export interface GenerateMFA200Response {
    /**
     * Secret MFA.
     * @type {string}
     * @memberof GenerateMFA200Response
     */
    'secret'?: string;
    /**
     * OTP MFA Link.
...
export const CloudApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        code: async (codeRequest?: CodeRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        disableMFA: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        enableMFA: async (enableMFA?: EnableMFA, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(enableMFA, localVarRequestOptions, configuration)
         ...
         * @summary Generate MFA connection
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        generateMFA: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/mfa/generate`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
        ...
        /**
         * Recovery Code MFA
         * @summary Checks the code to recover access
         * @param {RecoveryCode} [recoveryCode] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        recoveryCodes: async (recoveryCode?: RecoveryCode, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(recoveryCode, localVarRequestOptions, configuration)
...
export const CloudApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async code(codeRequest?: CodeRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EnableMFA200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.code(codeRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * creates a new customer defining, optionaly, the default payment method.
         ...
         * @throws {RequiredError}
         */
        async disableMFA(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * @throws {RequiredError}
         */
        async enableMFA(enableMFA?: EnableMFA, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EnableMFA200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.enableMFA(enableMFA, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * evaluate the namespace capabilities.
         ...
         * @throws {RequiredError}
         */
        async generateMFA(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GenerateMFA200Response>> {
         ...
         * @throws {RequiredError}
         */
        async recoveryCodes(recoveryCode?: RecoveryCode, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<EnableMFA200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.recoveryCodes(recoveryCode, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Register user
...
export const CloudApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        code(codeRequest?: CodeRequest, options?: any): AxiosPromise<EnableMFA200Response> {
            return localVarFp.code(codeRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * creates a new customer defining, optionaly, the default payment method.
         * @summary Create customer
         ...
         * @throws {RequiredError}
         */
        disableMFA(options?: any): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        enableMFA(enableMFA?: EnableMFA, options?: any): AxiosPromise<EnableMFA200Response> {
            return localVarFp.enableMFA(enableMFA, options).then((request) => request(axios, basePath));
        },
        /**
         * evaluate the namespace capabilities.
         * @summary Evaluate
         ...
         * @throws {RequiredError}
         */
        generateMFA(options?: any): AxiosPromise<GenerateMFA200Response> {
         ...
         * @throws {RequiredError}
         */
        recoveryCodes(recoveryCode?: RecoveryCode, options?: any): AxiosPromise<EnableMFA200Response> {
            return localVarFp.recoveryCodes(recoveryCode, options).then((request) => request(axios, basePath));
        },
        /**
         * Register user
         * @summary Register user
...
export class CloudApi extends BaseAPI {
     ...
     * @memberof CloudApi
     */
    public code(codeRequest?: CodeRequest, options?: AxiosRequestConfig) {
        return CloudApiFp(this.configuration).code(codeRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CloudApi
     */
    public disableMFA(options?: AxiosRequestConfig) {
        return CloudApiFp(this.configuration).disableMFA(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CloudApi
     */
    public enableMFA(enableMFA?: EnableMFA, options?: AxiosRequestConfig) {
        return CloudApiFp(this.configuration).enableMFA(enableMFA, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CloudApi
     */
    public recoveryCodes(recoveryCode?: RecoveryCode, options?: AxiosRequestConfig) {
        return CloudApiFp(this.configuration).recoveryCodes(recoveryCode, options).then((request) => request(this.axios, this.basePath));
    }
...
export class MfaApi extends BaseAPI {
     ...
     */
    public code(codeRequest?: CodeRequest, options?: AxiosRequestConfig) {
        return MfaApiFp(this.configuration).code(codeRequest, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     */
    public disableMFA(options?: AxiosRequestConfig) {
        return MfaApiFp(this.configuration).disableMFA(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     */
    public enableMFA(enableMFA?: EnableMFA, options?: AxiosRequestConfig) {
        return MfaApiFp(this.configuration).enableMFA(enableMFA, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     */
    public recoveryCodes(recoveryCode?: RecoveryCode, options?: AxiosRequestConfig) {
        return MfaApiFp(this.configuration).recoveryCodes(recoveryCode, options).then((request) => request(this.axios, this.basePath));
    }
}
