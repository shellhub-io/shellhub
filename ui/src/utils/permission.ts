...
const permissions = {
  ...
  "namespace:updateAllowRoot": Roles.ADMINISTRATOR,
  "namespace:updateAllowEmptyPasswords": Roles.ADMINISTRATOR,
  "namespace:updateAllowTTY": Roles.ADMINISTRATOR,
  "namespace:updateAllowTcpForwarding": Roles.ADMINISTRATOR,
  "namespace:updateAllowWebEndpoints": Roles.ADMINISTRATOR,
  "namespace:updateAllowSFTP": Roles.ADMINISTRATOR,
  "namespace:updateAllowAgentForwarding": Roles.ADMINISTRATOR,
