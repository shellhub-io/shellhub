<template>
  ...
  >
    <div class="text-center mb-6">
      ...
      <p class="text-subtitle-1 text-medium-emphasis">
        Confirm this device to add it to your account
      </p>
    </div>
    ...
    >
      <p
        class="mb-0"
        data-test="welcome-third-screen-text"
      >
    ...
    <v-expansion-panels>
      ...
      >
        ...
        <v-expansion-panel-text class="pt-2">
          ...
          <div
            v-if="firstPendingDevice.identity"
            class="mb-3"
          >
  ...
  >
    ...
    <h3
      class="text-h6 mb-2"
      data-test="no-device-heading"
    >
      No Device Detected Yet
    </h3>
    <p
      class="text-body-2 mb-0"
      data-test="no-device-text"
    >
