...
const ansibleLines: {
  ...
  { text: "ok: [device-01]", color: C.green, indent: true },
  { text: "ok: [device-02]", color: C.green, indent: true },
  { text: "" },
  {
    text: "TASK [Update firmware] ******************************",
    color: C.cyan,
  },
  { text: "changed: [device-01]", color: C.yellow, indent: true },
  { text: "changed: [device-02]", color: C.yellow, indent: true },
  { text: "" },
  {
  ...
  {
    text: "device-01  : ok=3  changed=1  failed=0",
    color: C.green,
    indent: true,
  },
  {
    text: "device-02  : ok=3  changed=1  failed=0",
    color: C.green,
    indent: true,
  },
];
...
const terraformLines: { text: string; color?: string; dim?: boolean }[] = [
  ...
  { text: "  ami           = var.ami_id", dim: true },
  { text: '  instance_type = "t3.micro"', dim: true },
  { text: "" },
  { text: "  user_data = <<-EOF", color: C.cyan },
  { text: "    #!/bin/bash", color: C.green },
  {
    text: "    curl -sSf https://cloud.shellhub.io/install.sh \\",
    color: C.green,
  },
  { text: "      | TENANT_ID=${var.tenant_id} sh", color: C.green },
  { text: "  EOF", color: C.cyan },
  { text: "" },
  { text: "  tags = {", dim: true },
...
const pipelineDeployLines: { text: string; color?: string; dim?: boolean }[] = [
  ...
  { text: "      run: |", dim: true },
  { text: "        ssh user@prod.device-01@shellhub.io \\", color: C.green },
  {
    text: '          "cd /opt/app && git pull && make restart"',
    color: C.green,
  },
  { text: "        ssh user@prod.device-02@shellhub.io \\", color: C.green },
  {
    text: '          "cd /opt/app && git pull && make restart"',
    color: C.green,
  },
