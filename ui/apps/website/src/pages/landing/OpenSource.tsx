        ...
        <Reveal>
          <div className="flex gap-3 justify-center flex-wrap">
            <a
              ...
              className="px-6 py-2.5 text-sm font-medium text-text-secondary border border-border rounded-lg hover:text-text-primary hover:border-border-light hover:bg-white/[0.04] transition-all inline-flex items-center gap-2"
            >
              <svg
                width="16"
                height="16"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-6 py-2.5 text-sm font-semibold bg-primary text-[#111214] rounded-lg hover:bg-primary-600 transition-all"
            >
              Try Cloud Free
            </a>
          </div>
