...
const ECDSA_P256_PRIVATE_KEY = `-----BEGIN OPENSSH PRIVATE KEY-----

cAAAAgREzZwCgFi9oTE/qfcQ34qdI2h7ca4alIgbHuIukqEe4AAAAA
-----END OPENSSH PRIVATE KEY-----`;
...
describe("generateSignature", () => {
  ...
  describe("ECDSA keys", () => {
    it("returns a non-empty base64 string for an ECDSA P-256 key", () => {
