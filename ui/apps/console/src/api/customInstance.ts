...
/**
 * Orval custom mutator — every generated SDK function calls this. `body` is sent as given, so a
 * JSON payload must arrive already serialized; the generated functions stringify their own.
 */
