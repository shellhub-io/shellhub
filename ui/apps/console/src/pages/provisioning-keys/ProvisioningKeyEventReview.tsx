...
import type { RequestDeviceAction } from "./provisioningKeyEventColumns";
...
function resolveVerdict(event: ProvisioningKeyEvent): ReviewVerdict | undefined {
...
/**
 * One enrolment made with a provisioning key, with the accept or reject where the key's mode leaves
 * the decision to a person.
 */
export default function ProvisioningKeyEventReview({
  event,
  requestAction,
}: {
