...
import ProvisioningKeyEventReview from "./ProvisioningKeyEventReview";
 ...
 */
export function getProvisioningKeyEventColumns(
  requestAction: RequestDeviceAction,
): Column<ProvisioningKeyEvent>[] {
  return [
    {
      key: "device",
      header: "Device",
    ...
    },
    {
      ...
      header: "Review",
      render: (event) => (
        <ProvisioningKeyEventReview event={event} requestAction={requestAction} />
      ),
    },
  ];
}
