...
/**
 * How much of a provisioning key's allowance is spent, and how much of it is claimed by devices still
...
export default function UsageMeter({
  ...
  const { inert, overused, revoked, disabled } = getKeyBlockers(provisioningKey);
  const reached = overused && !revoked && !disabled;
  const { waiting, beyondLimit, oversubscribed } = getWaitingInfo(provisioningKey);
