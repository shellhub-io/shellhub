...
function renderModal(
  ...
  return {
    ...
    ...render(<CreateUserModal {...props} />, { wrapper: Wrapper }),
  };
}
...
describe("CreateUserModal", () => {
  ...
  describe("submit — success", () => {
    it("posts the form values and closes the modal", async () => {
  ...
  describe("state reset on reopen", () => {
    it("clears the name field when closed then reopened", async () => {
      ...
      rerender(<CreateUserModal open={false} onClose={vi.fn()} />);
      rerender(<CreateUserModal open={true} onClose={vi.fn()} />);
