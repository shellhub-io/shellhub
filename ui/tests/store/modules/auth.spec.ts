...
describe("Auth Store", () => {
  ...
  describe("login", () => {
    ...
    it("should handle server errors during login", async () => {
      ...
      await expect(
        store.login({ username: "user", password: "password" }),
  ...
  describe("loginWithToken", () => {
    it("should login with token and get user info", async () => {
      ...
      mockUsersApi
        .onGet("http://localhost:3000/api/auth/user")
        .reply(200, mockResponse);
  ...
  describe("MFA - generateMfa", () => {
    it("should generate MFA secret and QR code", async () => {
      ...
      mockMfaApi
        .onGet("http://localhost:3000/api/user/mfa/generate")
        .reply(200, mockResponse);
    ...
    it("should handle error generating MFA", async () => {
      mockMfaApi
        .onGet("http://localhost:3000/api/user/mfa/generate")
        .reply(500, { message: "Failed to generate MFA" });
  ...
  describe("MFA - enableMfa", () => {
    it("should enable MFA successfully", async () => {
      ...
      mockMfaApi
        .onPut("http://localhost:3000/api/user/mfa/enable")
        .reply(200);
  ...
  describe("MFA - disableMfa", () => {
    it("should disable MFA successfully", async () => {
      ...
      mockMfaApi
        .onPut("http://localhost:3000/api/user/mfa/disable")
        .reply(200);
  ...
  describe("MFA - validateMfa", () => {
    it("should validate MFA code successfully", async () => {
      ...
      mockMfaApi
        .onPost("http://localhost:3000/api/user/mfa/auth")
        .reply(200, mockResponse);
  ...
  describe("MFA - recoverMfa", () => {
    it("should recover MFA with recovery code", async () => {
      ...
      mockMfaApi
        .onPost("http://localhost:3000/api/user/mfa/recover")
        .reply(200, mockResponse, {
          "x-expires-at": "1800",
        });
  ...
  describe("MFA - requestMfaReset", () => {
    it("should request MFA reset", async () => {
      ...
      mockMfaApi
        .onPost("http://localhost:3000/api/user/mfa/reset")
        .reply(200);
    ...
    it("should handle error requesting MFA reset", async () => {
      localStorage.setItem("name", "testuser");
  ...
  describe("MFA - resetMfa", () => {
    it("should reset MFA with validation", async () => {
      ...
      mockMfaApi
        .onPut("http://localhost:3000/api/user/mfa/reset/testuser")
        .reply(200, mockResponse);
  ...
  describe("enterInvitedNamespace", () => {
    it("should switch to invited namespace", async () => {
      ...
      mockNamespacesApi
        .onGet("http://localhost:3000/api/auth/token/invited-tenant")
        .reply(200, mockResponse);
    ...
    it("should handle error switching namespace", async () => {
      mockNamespacesApi
        .onGet("http://localhost:3000/api/auth/token/non-existent")
