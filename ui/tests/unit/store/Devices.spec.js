...
describe('Devices', () => {
  ...
  it('complete test', () => {
    const devices = [
      {'uid':'a582b47a42d', 'name':'39-5e-2a', 'identity':{'mac':'00:00:00:00:00:00'}, 'info':{'id':'debian', 'pretty_name':'Debian GNU/Linux 10 (buster)', 'version':'v0.2.5'}, 'public_key':'----- PUBLIC KEY -----', 'tenant_id':'00000000', 'last_seen':'2020-05-18T13:27:02.498Z', 'online':false, 'namespace':'user'},
      {'uid':'a582b47a42d', 'name':'39-5e-2a', 'identity':{'mac':'00:00:00:00:00:00'}, 'info':{'id':'debian', 'pretty_name':'Debian GNU/Linux 10 (buster)', 'version':'v0.2.5'}, 'public_key':'----- PUBLIC KEY -----', 'tenant_id':'00000000', 'last_seen':'2020-05-18T13:27:02.498Z', 'online':false, 'namespace':'user'}
    ];
    const device = {'uid':'a582b47a42d', 'name':'39-5e-2a', 'identity':{'mac':'00:00:00:00:00:00'}, 'info':{'id':'debian', 'pretty_name':'Debian GNU/Linux 10 (buster)', 'version':'v0.2.5'}, 'public_key':'----- PUBLIC KEY -----', 'tenant_id':'00000000', 'last_seen':'2020-05-18T13:27:02.498Z', 'online':false, 'namespace':'user'};
