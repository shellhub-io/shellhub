...
describe("Setup View", () => {
  ...
  describe("when page loads", () => {
    ...
    it("displays the account form directly", () => {
  ...
  describe("when account setup fails", () => {
    ...
    it("displays error alert on failure", async () => {
      ...
      expect(alert.text()).toContain("An error occurred. Please try again.");
    });
  });
  ...
  describe("form validation", () => {
    ...
    it("disables submit button when form fields are incomplete", () => {
  ...
  describe("onboarding step", () => {
    ...
    it("shows onboarding step as the first step", () => {
