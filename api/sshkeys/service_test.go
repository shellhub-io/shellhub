...
func TestCreatePublicKey(t *testing.T) {
	...
	//pubKey, _, _, _, err := ssh.ParseAuthorizedKey([]byte(sshRsa))
	//if err != nil {
	...
	//key2 := &models.PublicKey{
	//	Data: []byte(sshRsa), Fingerprint: fingerprint, TenantID: "tenant1", PublicKeyFields: models.PublicKeyFields{Name: "teste"},
	//}
