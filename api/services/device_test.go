...
func TestUpdateDeviceStatus(t *testing.T) {
	...
	cases := []struct {
		...
		{
			name: "failure - namespace not found",
			req: &requests.DeviceUpdateStatus{
			...
			requiredMocks: func() {
				storeMock.
					On("NamespaceGet", ctx, "invalid-tenant").
		...
		{
			name: "failure - device already accepted",
			req: &requests.DeviceUpdateStatus{
				TenantID: "00000000-0000-0000-0000-000000000000",
				UID:      "accepted-device",
				Status:   "accepted",
		...
		{
			name: "success (rejected) - status change to pending",
			req: &requests.DeviceUpdateStatus{
				TenantID: "00000000-0000-0000-0000-000000000000",
		...
		{
			name: "success (pending) - status change to rejected",
			req: &requests.DeviceUpdateStatus{
				TenantID: "00000000-0000-0000-0000-000000000000",
		...
		{
			name: "failure (accepted) (same MAC) - hostname conflict",
			req: &requests.DeviceUpdateStatus{
				TenantID: "00000000-0000-0000-0000-000000000000",
		...
		{
			name: "success (accepted) (same MAC) - device merge",
			req: &requests.DeviceUpdateStatus{
				TenantID: "00000000-0000-0000-0000-000000000000",
				UID:      "new-device",
				Status:   "accepted",
		...
		{
			name: "failure (accepted) (different MAC) - hostname conflict",
			req: &requests.DeviceUpdateStatus{
				TenantID: "00000000-0000-0000-0000-000000000000",
				UID:      "conflicting-device",
				Status:   "accepted",
		...
		{
			name: "failure (accepted) (different MAC) - device limit reached [community]",
			req: &requests.DeviceUpdateStatus{
				TenantID: "00000000-0000-0000-0000-000000000000",
				UID:      "limit-device",
				Status:   "accepted",
		...
		{
			name: "success (accepted) (different MAC) - device acceptance [community]",
			req: &requests.DeviceUpdateStatus{
				TenantID: "00000000-0000-0000-0000-000000000000",
				UID:      "pending-device",
				Status:   "accepted",
		...
		{
			name: "failure (accepted) (different MAC) - device limit reached [enterprise]",
			req: &requests.DeviceUpdateStatus{
				TenantID: "00000000-0000-0000-0000-000000000000",
				UID:      "limit-device",
				Status:   "accepted",
		...
		{
			name: "success (accepted) (different MAC) - device acceptance [enterprise]",
			req: &requests.DeviceUpdateStatus{
				TenantID: "00000000-0000-0000-0000-000000000000",
				UID:      "pending-device",
				Status:   "accepted",
		...
		{
			name: "failure (accepted) (different MAC) (billing inactive) - removed device delete error [cloud]",
			req: &requests.DeviceUpdateStatus{
				TenantID: "00000000-0000-0000-0000-000000000000",
				UID:      "removed-delete-error",
				Status:   "accepted",
			},
			requiredMocks: func() {
				storeMock.
				...
				queryOptionsMock.
					...
					Once()
				storeMock.
					On("DeviceResolve", ctx, store.DeviceUIDResolver, "removed-delete-error", mock.AnythingOfType("store.QueryOption")).
					Return(
						&models.Device{
							UID:      "removed-delete-error",
							Name:     "test-device",
				...
				envMock.
					...
					Twice()
				storeMock.
					On("DeviceRemovedGet", ctx, "00000000-0000-0000-0000-000000000000", models.UID("removed-delete-error")).
					Return(
						&models.DeviceRemoved{
							Device: &models.Device{
								UID:      "removed-delete-error",
								TenantID: "00000000-0000-0000-0000-000000000000",
							},
				...
				storeMock.
					...
					Once()
				storeMock.
					On("DeviceRemovedDelete", ctx, "00000000-0000-0000-0000-000000000000", models.UID("removed-delete-error")).
					Return(errors.New("delete error", "", 0)).
					Once()
			},
			expectedError: NewErrDeviceRemovedDelete(errors.New("delete error", "", 0)),
		},
		{
			name: "failure (accepted) (different MAC) (billing inactive) - billing evaluate [cloud]",
			req: &requests.DeviceUpdateStatus{
				TenantID: "00000000-0000-0000-0000-000000000000",
				UID:      "removed-device",
				Status:   "accepted",
			...
			requiredMocks: func() {
				...
				envMock.
					...
					Twice()
				storeMock.
					On("DeviceRemovedGet", ctx, "00000000-0000-0000-0000-000000000000", models.UID("removed-device")).
					Return(
						&models.DeviceRemoved{
							Device: &models.Device{
								UID:      "removed-device",
				...
				storeMock.
					...
					Once()
				storeMock.
					On("DeviceRemovedDelete", ctx, "00000000-0000-0000-0000-000000000000", models.UID("removed-device")).
					Return(nil).
					Once()
				clientMock.
		...
		{
			name: "failure (accepted) (different MAC) (billing inactive) - can't accept [cloud]",
			req: &requests.DeviceUpdateStatus{
				TenantID: "00000000-0000-0000-0000-000000000000",
				UID:      "removed-device",
				Status:   "accepted",
		...
		{
			name: "success (accepted) (different MAC) (billing inactive) - removed device [cloud]",
			req: &requests.DeviceUpdateStatus{
				TenantID: "00000000-0000-0000-0000-000000000000",
				UID:      "removed-device",
				Status:   "accepted",
		...
		{
			name: "failure (accepted) (different MAC) (billing active) - billing report error [cloud]",
			req: &requests.DeviceUpdateStatus{
				TenantID: "00000000-0000-0000-0000-000000000000",
		...
		{
			name: "failure (accepted) (different MAC) (billing active) - payment required [cloud]",
			req: &requests.DeviceUpdateStatus{
				TenantID: "00000000-0000-0000-0000-000000000000",
		...
		{
			name: "success (accepted) (different MAC) (billing active) - device acceptance [cloud]",
			req: &requests.DeviceUpdateStatus{
				TenantID: "00000000-0000-0000-0000-000000000000",
				UID:      "cloud-device",
				Status:   "accepted",
