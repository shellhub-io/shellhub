...
func (_m *Service) CreatePublicKey(ctx context.Context, req requests.PublicKeyCreate, tenant string) (*models.PublicKey, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, requests.PublicKeyCreate, string) (*models.PublicKey, error)); ok {
		return rf(ctx, req, tenant)
	}
	if rf, ok := ret.Get(0).(func(context.Context, requests.PublicKeyCreate, string) *models.PublicKey); ok {
