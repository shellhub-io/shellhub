...
// UpdateDeviceConnectionStats provides a mock function with given fields: ctx, req
func (_m *Service) UpdateDeviceConnectionStats(ctx context.Context, req *requests.DeviceUpdateConnectionStats) error {
	ret := _m.Called(ctx, req)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *requests.DeviceUpdateConnectionStats) error); ok {
		r0 = rf(ctx, req)
	} else {
		r0 = ret.Error(0)
	}
