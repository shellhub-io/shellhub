...
func (_m *Service) PullTagFrom(ctx context.Context, target models.TagTarget, req *requests.PullTag) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, models.TagTarget, *requests.PullTag) error); ok {
...
func (_m *Service) PushTagTo(ctx context.Context, target models.TagTarget, req *requests.PushTag) error {
	ret := _m.Called(ctx, target, req)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, models.TagTarget, *requests.PushTag) error); ok {
		r0 = rf(ctx, target, req)
	} else {
		r0 = ret.Error(0)
	}
