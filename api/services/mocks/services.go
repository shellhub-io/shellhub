...
func (_m *Service) GetTags(ctx context.Context, tenant string) ([]models.Tags, int, error) {
	...
	var r1 int
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, string) ([]models.Tags, int, error)); ok {
		return rf(ctx, tenant)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) []models.Tags); ok {
		r0 = rf(ctx, tenant)
	} else {
		if ret.Get(0) != nil {
