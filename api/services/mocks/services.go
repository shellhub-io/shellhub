...
// DeleteDeviceCustomField provides a mock function with given fields: ctx, req
func (_m *Service) DeleteDeviceCustomField(ctx context.Context, req *requests.DeviceDeleteCustomField) error {
	ret := _m.Called(ctx, req)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *requests.DeviceDeleteCustomField) error); ok {
		r0 = rf(ctx, req)
	} else {
		r0 = ret.Error(0)
	}
...
// SetDeviceCustomField provides a mock function with given fields: ctx, req
func (_m *Service) SetDeviceCustomField(ctx context.Context, req *requests.DeviceSetCustomField) error {
	ret := _m.Called(ctx, req)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *requests.DeviceSetCustomField) error); ok {
		r0 = rf(ctx, req)
	} else {
		r0 = ret.Error(0)
	}
