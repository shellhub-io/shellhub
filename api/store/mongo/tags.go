...
func (s *Store) TagsGet(ctx context.Context, tenant string) ([]models.Tags, int, error) {
...
func (s *Store) TagsPushTag(ctx context.Context, tagName, tenant_id string) error {
	tag := new(models.Tags)
...
func (s *Store) TagsGetTags(ctx context.Context, tenant string) ([]models.Tags, int, error) {
