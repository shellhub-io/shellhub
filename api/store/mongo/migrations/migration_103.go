...
var migration103 = migrate.Migration{
	Version:     103,
	Description: "Add devices_removed_count field to namespaces based on removed_devices collection",
	Up: migrate.MigrationFunc(func(ctx context.Context, db *mongo.Database) error {
		...
		for cursor.Next(ctx) {
			...
			log.WithFields(log.Fields{"tenant_id": result.ID, "count": result.Count}).Info("Updated namespace devices_removed_count")
		}
