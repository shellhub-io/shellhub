...
type TagsStore interface {
	...
	TagPushToTarget(ctx context.Context, id string, target models.TagTarget, targetID string) (err error)
	...
	TagPullFromTarget(ctx context.Context, id string, target models.TagTarget, targetIDs ...string) (err error)
