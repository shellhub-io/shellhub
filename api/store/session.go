...
type SessionStore interface {
	...
	ActiveSessionCreate(ctx context.Context, uid models.UID, session *models.Session) error
	...
	SessionEventsCreate(ctx context.Context, uid models.UID, event *models.SessionEvent) error
