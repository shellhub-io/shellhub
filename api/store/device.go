...
type DeviceStore interface {
	...
	DeviceList(ctx context.Context, status models.DeviceStatus, pagination query.Paginator, sorter query.Sorter, acceptable DeviceAcceptable, opts ...QueryOption) ([]models.Device, int, error)
