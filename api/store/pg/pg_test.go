...
import (
	...
	"github.com/shellhub-io/shellhub/api/store/pg/internal/dbtest"
...
func TestMain(m *testing.M) {
	...
	if err := srv.Up(ctx, false); err != nil {
	...
	s, err = pg.New(ctx, c, options.Migrate(filepath.Dir(file)), options.WithFixtures(dbtest.FixturesPath()))
	if err != nil {
