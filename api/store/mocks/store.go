...
// DeviceSwapAccepted provides a mock function with given fields: ctx, uid, oldDevice
func (_m *Store) DeviceSwapAccepted(ctx context.Context, uid models.UID, oldDevice *models.Device) error {
	ret := _m.Called(ctx, uid, oldDevice)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, models.UID, *models.Device) error); ok {
		r0 = rf(ctx, uid, oldDevice)
	} else {
		r0 = ret.Error(0)
	}
