...
// BillingActiveInstances provides a mock function with given fields: ctx
func (_m *Store) BillingActiveInstances(ctx context.Context) ([]models.Namespace, int, error) {
	ret := _m.Called(ctx)
