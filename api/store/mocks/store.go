...
// DeviceEdit provides a mock function with given fields: ctx, tenant, uid, changes
func (_m *Store) DeviceEdit(ctx context.Context, tenant string, uid string, changes *models.DeviceChanges) error {
	ret := _m.Called(ctx, tenant, uid, changes)

	if len(ret) == 0 {
		panic("no return value specified for DeviceEdit")
	}
