...
// SessionGet provides a mock function with given fields: ctx, tenant, uid
func (_m *Store) SessionGet(ctx context.Context, tenant string, uid models.UID) (*models.Session, error) {
	ret := _m.Called(ctx, tenant, uid)
