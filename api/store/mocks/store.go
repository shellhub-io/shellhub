...
// ActiveSessionCreate provides a mock function with given fields: ctx, uid, session
func (_m *Store) ActiveSessionCreate(ctx context.Context, uid models.UID, session *models.Session) error {
...
// SessionEventsCreate provides a mock function with given fields: ctx, uid, event
func (_m *Store) SessionEventsCreate(ctx context.Context, uid models.UID, event *models.SessionEvent) error {
