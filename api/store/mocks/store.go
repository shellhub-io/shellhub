...
func (_m *Store) SystemSet(ctx context.Context, key string, value any) error {
...
// TagGet provides a mock function with given fields: ctx, tagName, tenant
func (_m *Store) TagGet(ctx context.Context, tagName string, tenant string) (*models.Tags, error) {
	ret := _m.Called(ctx, tagName, tenant)

	if len(ret) == 0 {
		panic("no return value specified for TagGet")
	}

	var r0 *models.Tags
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) (*models.Tags, error)); ok {
		return rf(ctx, tagName, tenant)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string) *models.Tags); ok {
		r0 = rf(ctx, tagName, tenant)
	} else {
		if ret.Get(0) != nil {
...
// TagsBulkDeleteTag provides a mock function with given fields: ctx, tenant, tagName
func (_m *Store) TagsBulkDeleteTag(ctx context.Context, tenant string, tagName string) (int64, error) {
	ret := _m.Called(ctx, tenant, tagName)

	if len(ret) == 0 {
		panic("no return value specified for TagsBulkDeleteTag")
	}

	var r0 int64
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) (int64, error)); ok {
		return rf(ctx, tenant, tagName)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string) int64); ok {
		r0 = rf(ctx, tenant, tagName)
	} else {
		r0 = ret.Get(0).(int64)
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, string) error); ok {
		r1 = rf(ctx, tenant, tagName)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *Store) TagsGet(ctx context.Context, tenant string) ([]models.Tags, int64, error) {
	ret := _m.Called(ctx, tenant)
	...
	var r1 int64
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, string) ([]models.Tags, int64, error)); ok {
		return rf(ctx, tenant)
	}
...
// TagsGetTags provides a mock function with given fields: ctx, tenant
func (_m *Store) TagsGetTags(ctx context.Context, tenant string) ([]models.Tags, int64, error) {
	ret := _m.Called(ctx, tenant)

	if len(ret) == 0 {
		panic("no return value specified for TagsGetTags")
	}
...
// TagsPushTag provides a mock function with given fields: ctx, tagName, tenantID
func (_m *Store) TagsPushTag(ctx context.Context, tagName string, tenantID string) error {
	ret := _m.Called(ctx, tagName, tenantID)

	if len(ret) == 0 {
		panic("no return value specified for TagsPushTag")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) error); ok {
		r0 = rf(ctx, tagName, tenantID)
	} else {
		r0 = ret.Error(0)
	}
