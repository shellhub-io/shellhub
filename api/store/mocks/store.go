...
// APIKeySave provides a mock function with given fields: ctx, apiKey
func (_m *Store) APIKeySave(ctx context.Context, apiKey *models.APIKey) error {
	ret := _m.Called(ctx, apiKey)

	if len(ret) == 0 {
		panic("no return value specified for APIKeySave")
	}
