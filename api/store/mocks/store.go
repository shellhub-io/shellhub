...
// DeviceDeleteCustomField provides a mock function with given fields: ctx, uid, key
func (_m *Store) DeviceDeleteCustomField(ctx context.Context, uid string, key string) error {
	ret := _m.Called(ctx, uid, key)
...
// DeviceSetCustomField provides a mock function with given fields: ctx, uid, key, value
func (_m *Store) DeviceSetCustomField(ctx context.Context, uid string, key string, value string) error {
	ret := _m.Called(ctx, uid, key, value)
