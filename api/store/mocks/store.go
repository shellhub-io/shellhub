...
// UserGetByExternalID provides a mock function with given fields: ctx, id
func (_m *Store) UserGetByExternalID(ctx context.Context, id string) (*models.User, error) {
	ret := _m.Called(ctx, id)

	if len(ret) == 0 {
		panic("no return value specified for UserGetByExternalID")
	}
