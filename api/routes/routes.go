...
func NewRouter(service services.Service, opts ...Option) *echo.Echo {
	...
	publicAPI.GET(AuthManualUserURLV2, gateway.Handler(handler.CreateUserToken))                                   // TODO: method POST
	...
	publicAPI.POST(AuthManualUserURL, gateway.Handler(handler.AuthManualUser))
	publicAPI.POST(AuthManualUserURLV2, gateway.Handler(handler.AuthManualUser))
