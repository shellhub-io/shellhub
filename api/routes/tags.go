...
const (
	...
	URLPushTagToPublicKey   = "/namespaces/:tenant/sshkeys/:fingerprint/tags/:name"
	URLPullTagFromPublicKey = "/namespaces/:tenant/sshkeys/:fingerprint/tags/:name"
)
...
func (h *Handler) PushTagToPublicKey(c gateway.Context) error {
	...
	if err := h.service.PushTagTo(c.Ctx(), store.TagTargetPublicKey, req); err != nil {
		return err
	}
...
func (h *Handler) PullTagFromPublicKey(c gateway.Context) error {
	...
	if err := h.service.PullTagFrom(c.Ctx(), store.TagTargetPublicKey, req); err != nil {
		return err
	}
