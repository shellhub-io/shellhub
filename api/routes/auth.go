...
func (h *Handler) authRequest() *Route {
	return &Route{
		endpoint:              "/auth",
		method:                MethodGet,
		group:                 GroupInternal,
...
func (h *Handler) authDevice() *Route {
	return &Route{
		endpoint:              "/auth/device",
		deprecatedEndpoints:   []string{"/devices/auth"},
		method:                MethodPost,
		group:                 GroupPublic,
		requiresAuthorization: false,
		blockAPIKey:           false,
...
func (h *Handler) authUser() *Route {
	return &Route{
		endpoint:              "/auth/user",
		deprecatedEndpoints:   []string{"/login"},
		method:                MethodPost,
		group:                 GroupPublic,
		blockAPIKey:           false,
		requiresAuthorization: false,
...
func (h *Handler) getUserAuthInfo() *Route {
	return &Route{
		endpoint:              "/auth/user",
		method:                MethodGet,
		group:                 GroupPublic,
...
func (h *Handler) getUserAuthToken() *Route {
	return &Route{
...
func (h *Handler) swapUserAuthToken() *Route {
	return &Route{
		endpoint:              "/auth/token/:tenant",
		method:                MethodGet, // TODO: method post
		group:                 GroupPublic,
		requiresAuthorization: false,
		blockAPIKey:           true,
		middlewares:           []echo.MiddlewareFunc{},
...
func (h *Handler) authPublicKey() *Route {
	return &Route{
		endpoint:              "/auth/ssh",
		method:                MethodPost,
		group:                 GroupPublic,
