...
var (
	...
	ErrRootDisabled              = fmt.Errorf("root login is disabled for this device")
	ErrEmptyPasswordNotPermitted = fmt.Errorf("empty passwords are not permitted for this device")
)
