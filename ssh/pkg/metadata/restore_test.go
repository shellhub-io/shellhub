...
func TestRestoreAuthenticationMethod(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			expected: InvalidAuthenticationMethod,
		},
		{
			...
			setup: func(ctx *gliderssh.Context) *sshsrvtest.Conn {
				return sshsrvtest.New(
					&gliderssh.Server{
						Handler: func(s gliderssh.Session) {
							s.Context().SetValue(authentication, PasswordAuthenticationMethod)
							*ctx = s.Context()
						},
					},
					&gossh.ClientConfig{
...
func TestRestoreAgent(t *testing.T) {
	cases := []struct {
		description string
		setup       func(ctx *gliderssh.Context) *sshsrvtest.Conn
		expected    *gossh.Client
	}{
		{
			description: "fails when agent is not set",
			setup: func(ctx *gliderssh.Context) *sshsrvtest.Conn {
				return sshsrvtest.New(
					&gliderssh.Server{
						Handler: func(s gliderssh.Session) {
		...
		{
			description: "succeeds in restoring agent",
			setup: func(ctx *gliderssh.Context) *sshsrvtest.Conn {
				return sshsrvtest.New(
					&gliderssh.Server{
						Handler: func(s gliderssh.Session) {
							s.Context().SetValue(agent, &gossh.Client{})
							*ctx = s.Context()
						},
					},
					&gossh.ClientConfig{
...
func TestRestoreEstablished(t *testing.T) {
	cases := []struct {
		...
		{
			description: "fails when established is not set",
			setup: func(ctx *gliderssh.Context) *sshsrvtest.Conn {
				return sshsrvtest.New(
					&gliderssh.Server{
						Handler: func(s gliderssh.Session) {
		...
		{
			description: "succeeds in restoring established",
			setup: func(ctx *gliderssh.Context) *sshsrvtest.Conn {
				return sshsrvtest.New(
					&gliderssh.Server{
						Handler: func(s gliderssh.Session) {
