...
func (_m *Metadata) RestoreAuthenticationMethod(ctx ssh.Context) metadata.AuthMethod {
	ret := _m.Called(ctx)

	var r0 metadata.AuthMethod
	if rf, ok := ret.Get(0).(func(ssh.Context) metadata.AuthMethod); ok {
		r0 = rf(ctx)
	} else {
		r0 = ret.Get(0).(metadata.AuthMethod)
	}
...
// RestoreUID provides a mock function with given fields: ctx
func (_m *Metadata) RestoreUID(ctx ssh.Context) string {
	ret := _m.Called(ctx)
...
func (_m *Metadata) StoreAuthenticationMethod(ctx ssh.Context, method metadata.AuthMethod) {
