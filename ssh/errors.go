...
var (
	...
	ErrForbiddenPublicKey   = errors.New(fmt.Errorf("could not be used to peform this action with public key"), fmt.Errorf("this public key could not be used to that action"))
	...
	ErrSigner               = errors.New(fmt.Errorf("could not create the signer"), fmt.Errorf("it could not create the signer"))
