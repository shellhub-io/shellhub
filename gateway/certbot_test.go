...
func TestTunnelsCertificate_generate(t *testing.T) {
	tests := []struct {
		...
		staging     bool
		expected    error
		expectCalls func(*gatewayMocks.MockExecutor)
	}{
		{
			...
			expectCalls: func(executorMock *gatewayMocks.MockExecutor) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(tt *testing.T) {
			executorMock := new(gatewayMocks.MockExecutor)
...
func TestCertBot_renewCertificates(t *testing.T) {
	...
	tests := []struct {
		name              string
		config            Config
		expectCalls       func(*gatewayMocks.MockExecutor, *gatewayMocks.MockTicker)
	...
	}{
		{
			...
			expectCalls: func(executorMock *gatewayMocks.MockExecutor, tickerMock *gatewayMocks.MockTicker) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(tt *testing.T) {
			...
			tickerMock := new(gatewayMocks.MockTicker)
			executorMock := new(gatewayMocks.MockExecutor)
