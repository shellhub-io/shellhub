...
func (s *Suite) Run(t *testing.T) {
	...
	t.Run("ScopeIsolation", func(t *testing.T) {
		...
		s.TestScopeIsolationDeviceConflicts(t)
		s.TestScopeIsolationSessionResolve(t)
		s.TestScopeIsolationSessionList(t)
		s.TestScopeIsolationTagResolve(t)
		s.TestScopeIsolationTagList(t)
		s.TestScopeIsolationTagConflicts(t)
		s.TestScopeIsolationInstallKeyResolve(t)
		s.TestScopeIsolationInstallKeyList(t)
		s.TestScopeIsolationInstallKeyConflicts(t)
		s.TestScopeIsolationInstallKeyResolveSystem(t)
		s.TestScopeIsolationInstallKeyResolveSystemPairing(t)
		s.TestScopeIsolationInstallKeyEventList(t)
		s.TestScopeIsolationInstallKeyEventStampDecision(t)
		s.TestScopeIsolationAPIKeyResolve(t)
		s.TestScopeIsolationAPIKeyList(t)
		s.TestScopeIsolationAPIKeyConflicts(t)
		s.TestScopeIsolationPublicKeyResolve(t)
		s.TestScopeIsolationPublicKeyList(t)
		s.TestScopeIsolationNamespaceGetMembers(t)
		s.TestScopeIsolationNamespaceIncrementDeviceCount(t)
		s.TestScopeIsolationMembershipWrites(t)
		...
		s.TestScopeIsolationSSHIdentityResolve(t)
		s.TestScopeRejectsUnconstructedScope(t)
	})
}
