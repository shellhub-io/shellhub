...
func NewTunnel(router *echo.Echo, connection, dial, redisURI string) (*Tunnel, error) {
	...
	// TODO: Add router when creating the tunnel.
	tunnel.router = tunnel.Tunnel.Router(router)
