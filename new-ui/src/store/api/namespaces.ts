...
export const putNamespace = async (data: any) => namespacesApi.editNamespace(data.id, { name: data.name });
...
export const editUserToNamespace = async (data: any) => namespacesApi.updateNamespaceMember(data.tenant_id, data.user_id, {
  role: data.role,
});
